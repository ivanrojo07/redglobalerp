...
@section('content')
	<div class="card">
		...
		<div class="card-body">
			<form method="POST" action="{{ url('prospectos/'.$prospecto->id.'/transformar') }}" enctype="multipart/form-data">
				@csrf
				{{-- @if ($edit)
					@method('PUT')
				@endif --}}
				...
				<div class="row form-group mt-3">
					<div class="{{ $tipo_cliente == "nacional" ? 'col-3' : 'col-4'}}">
						...
						<input type="text" class="form-control" name="razon_social" value="{{ $prospecto->razon_social }}" readonly="">
					</div>
					<div class="{{ $tipo_cliente == "nacional" ? 'col-3' : 'col-4'}}">
					...
					<div class="{{ $tipo_cliente == "nacional" ? 'col-3' : 'col-4'}}">
						...
						<input type="text" class="form-control" name="rfc_tax_ruc_nit" required="">
					</div>
				...
				<div class="row form-group">
					...
					<div class="col-2">
						...
						<input class="form-control" type="text" name="num_ext" required="">
					</div>
					<div class="col-2">
				...
				<div class="row form-group">
					<div class="col-4">
						...
						<input class="form-control" type="text" name="alcaldia_ciudad" required="">
					</div>
					<div class="col-4">
				...
				<div class="row form-group">
					<div class="col-4">
						...
						<input class="form-control" type="text" name="telefono" value="{{ $prospecto->telefono }}" readonly="">
					</div>
					<div class="col-4">
						<label class="control-label">{{ __('Correo electronico (conforme a su registro fiscal)') }}</label>
						<input class="form-control" type="email" name="email" value="{{ $prospecto->correo }}" readonly="">
					</div>
				</div>
				{{-- DATOS DE COBRANZA --}}
				<div class="row mt-3 card-header justify-content-center">
				...
				<div class="row form-group">
					...
					<div class="col-4">
						...
						<input class="form-control" type="text" name="dia_revision_factura" required="">
					</div>
					<div class="col-4">
						<label class="control-label">{{ __('Días de pago') }}</label>
						<input class="form-control" type="text" name="dia_pago" required="">
					</div>
				</div>
				...
				<div class="row form-group mt-3">
					<div class="col-4">
						...
						<input class="form-control" type="text" name="nombre_b" required="">
					</div>
					<div class="col-2">
						<label class="control-label">{{ __('Plaza') }}</label>
						<input class="form-control" type="text" name="plaza" required="">
					</div>
					<div class="col-2">
						<label class="control-label">{{ __('Sucursal') }}</label>
						<input class="form-control" type="text" name="sucursal" required="">
					</div>
					<div class="col-4">
						<label class="control-label">{{__('Número de cuenta')}}</label>
						<input class="form-control" type="text" name="cuenta" required="">
					</div>
				</div>
				@if ($tipo_cliente != "nacional")
					{{-- Extranjeros --}}
				...
				<div class="row form-group mt-3">
						<div class="col-4">
							<label class="control-label">{{ __('Nombre') }}</label>
							<input class="form-control" type="text" name="nombre_l" required="">
						</div>
						{{-- @if ($tipo_cliente == "nacional") --}}
							<div class="col-4">
						...
						<div class="col-4">
							...
							<input class="form-control" type="date" name="fecha_l" required="">
						</div>
				</div>
				<div class="row mt-3 card-header justify-content-center">
					<h5>{{ __('Documentos') }}</h5>
...
@section('script')
	<script type="text/javascript">
		$("input[name=tipo_cliente]").change(function(res){
			...
			window.location.href = "{{ url('prospectos/'.$prospecto->id.'/cliente') }}/"+selValue;
